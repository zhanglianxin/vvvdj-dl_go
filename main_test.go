...
func TestSave2File(t *testing.T) {
	mocks := []struct {
		...
		{map[string]string{"url": "http://t.h.vvvdj.com/face/c2/2018/04/159717-7ec72a.mp4?upt=bb46cf791588043067&play.mp4", "name": "159717-7ec72a.mp4", "path": "data/3454/"}, "f6221a402f39abd0e586d77073ca21af"},
	}
